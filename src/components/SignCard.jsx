...
export default function SignCard() {
  ...
  return (
    <div className='flex flex-col gap-2.5'>
        ...
        <div key={index} className='flex  border border-gray-300 p-1 rounded-2xl bg-seashellpeach-50 '>
          ...
          <div className='mt-1'>
            <i className="fa-solid fa-trash-can pr-3 text-red-500 text-base  hover:text-red-800 "
